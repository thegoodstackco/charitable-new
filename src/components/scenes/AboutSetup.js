...
const About = (props) => {
  ...
  useFocusEffect(
    useCallback(() => {
      if (pinCodeRef.current && pinCodeRef.current.isFocused()) {
              ...
              <View style={[Custompadding.paddingLeftRightRegular]}>
                ...
                <>
                  <View style={[Custompadding.paddingBottomRegular]}>
                    <CustomInput
                      ...
                      returnKeyType="next"
                      onSubmitEditing={() => {
                        if (pinCodeRef.current) pinCodeRef.current.focus();
                      }}
                    />
                  </View>
                  {/* <View style={[Custompadding.paddingBottomRegular]}>
                  ...
                  <View style={[Custompadding.paddingBottomRegular]}>
                    <CustomInput
                      ...
                      returnKeyType="done"
                      onSubmitEditing={() => {
                        if (shortDescRef.current) shortDescRef.current.focus();
                      }}
                    />
                  </View>
                </>
                ...
                >
                  <CustomInput
                    ...
                    returnKeyType="next"
                    onSubmitEditing={() => {
                      if (longDescRef.current) longDescRef.current.focus();
                    }}
                  />
                </View>
                <View>
                  <CustomInput
                    ...
                    returnKeyType="next"
                    onSubmitEditing={() => {
                      if (tagRef.current) tagRef.current.focus();
                    }}
                  />
                </View>
              </View>
